    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden flex flex-col font-sans animate-in fade-in zoom-in-95 duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 text-sm text-gray-800 space-y-5">
          <div>
            <label className="block text-xs font-bold text-gray-500 uppercase mb-1.5 font-mono">Nombre de la Masa *</label>
            <input 
              type="text" 
              name="nombre" 
              required 
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-1.5 font-mono">Unidad de Medida *</label>
              <select
                name="unidad_medida"
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-1.5 font-mono">Costo Unitario (Bs) *</label>
              <input 
                type="number" 
                step="0.01"
                min="0"
          ...
          <div>
            <label className="block text-xs font-bold text-gray-500 uppercase mb-1.5 font-mono">Stock Mínimo de Alerta *</label>
            <input 
              type="number" 
              step="0.01"
              min="0"
