...
export default function POSPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-auto md:h-screen w-full bg-stone-950 text-stone-100 font-sans antialiased md:overflow-hidden">

      {/* Panel Izquierdo: Catálogo y Categorías */}
      <div className="flex-1 flex flex-col md:h-full md:overflow-hidden border-b md:border-b-0 md:border-r border-stone-800">
        ...
        <div className="flex-1 min-h-[420px] md:min-h-0 overflow-y-auto p-4 bg-stone-950 scrollbar-thin">
          {loading ? (
      ...
      <div className="w-full md:w-96 bg-stone-900 flex flex-col h-auto md:h-full shadow-2xl shadow-black/40 z-10">
        ...
        {/* Lista de Compra */}
        <div className="flex-1 min-h-[220px] md:min-h-0 overflow-y-auto p-4 bg-stone-900 scrollbar-thin">
          {cart.length === 0 ? (
